...
---
## 6) 생각해보기
### Q 01. 어떤 상황에서 TDD가 비효율적일 수 있습니까?

- 짧은 시간 내에 제품을 출시해야 하는 상황에서는 TDD를 통해 테스트 코드를 작성하고 리팩토링하는 과정이 부담스럽고 비효율적일 수 있습니다.

### Q 02. 실제 업무에 TDD를 적용할 수 있는 환경인지?
- 기존 코드 베이스가 크고, 테스트가 잘 안되어 있는 환경에서 리팩토링하면서 TDD를 도입하기에는 시간이 많이 소요되기 때문에 부담이 됩니다.